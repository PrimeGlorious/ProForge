...
urlpatterns = [
    ...
    path(
        "vacancies/create/",
        VacanciesCreateView.as_view(),
        name="vacancies_create"
    ),
    path(
        "vacancies/manage/",
        VacanciesManageView.as_view(),
        name="vacancies_manage"
    ),
    path(
